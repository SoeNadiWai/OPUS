    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.parent_view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                String cn=cakeobjs.get(position).getCake_name();
                String fa=cakeobjs.get(position).getCake_flavor();
                String price=cakeobjs.get(position).getCake_price();
                String img=cakeobjs.get(position).getCake_image();
                int imgpos=position;
                Intent intent = new Intent(activity, Cake_details.class);
                intent.putExtra("CakeName",cn);
                intent.putExtra("CakeFlavor",fa);
                intent.putExtra("CakePrice",price);
                intent.putExtra("CakeImg",img);
